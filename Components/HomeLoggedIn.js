            ...
            <View style={styles.homeLoggedIn}>
                <Text style={[styles.nearbyPosts, styles.postsTypo]}>Nearby posts</Text>
      			...
      			<View style={styles.frameContainer}>
        				<Image style={[styles.frameChild, styles.frameChildLayout1]} resizeMode="cover" source={require('D:/Sparsh/project/assets/Frame 286.png')} />
      			...
      			<View style={styles.frameParent1}>
        				<Image style={[styles.frameChild, styles.frameChildLayout1]} resizeMode="cover" source={require('D:/Sparsh/project/assets/Frame 288.png')}  />
        				<View style={styles.frameGroup}>
          					<View>
            						<Text style={[styles.acForRent, styles.rs1000Typo]}>Ac for Rent</Text>
            						<Text style={[styles.yearsOldIn, styles.month1Typo]}>{`3 years old in brand new... `}</Text>
      			...
      			<View style={styles.frameParent3}>
        				<Image style={[styles.frameChild, styles.frameChildLayout1]} resizeMode="cover" source={require('D:/Sparsh/project/assets/Frame 289.png')}  />
        				<View style={styles.frameGroup}>
          					<View>
            						<Text style={[styles.acForRent, styles.rs1000Typo]}>Ac for Rent</Text>
            						<Text style={[styles.yearsOldIn, styles.month1Typo]}>{`3 years old in brand new... `}</Text>
      			...
      			<View style={[styles.frameParent5, styles.frameParentPosition1]}>
        				<ImageBackground style={[styles.frameChild, styles.frameChildLayout1]} resizeMode="cover" source={require('D:/Sparsh/project/assets/Frame 287.png')} >
      			...
      			<View style={[styles.frameParent7, styles.frameParentPosition1]}>
        				<Image style={[styles.frameChild, styles.frameChildLayout1]} resizeMode="cover" source={require('D:/Sparsh/project/assets/Frame 287.png')}  />
        				<View style={styles.frameGroup}>
          					<View>
            						<Text style={[styles.acForRent, styles.rs1000Typo]}>Bed for rent</Text>
            						<Text style={[styles.yearsOldIn, styles.month1Typo]}>{`2 years old in brand new... `}</Text>
      			...
      			<Pressable style={[styles.homeLoggedInInner, styles.frameParentPosition]} onPress={()=>{}}>
        				<View style={styles.searchHereParent}>
          					<Text style={[styles.searchHere, styles.address1Typo]}>Search here</Text>
          					<Image style={[styles.frameChild4, styles.frameChildLayout]} resizeMode="cover" source={require('D:/Sparsh/project/assets/majesticons_search-line.png')}  />
        				</View>
      			</Pressable>
      			<View style={[styles.frameParent13, styles.frameParentPosition]}>
        				...
        				<View style={styles.ellipseParent}>
          					<Image style={styles.ellipseIcon} resizeMode="cover" source="Ellipse 35.png" />
          					<Image style={[styles.rinotification3LineIcon, styles.iconLayout]} resizeMode="cover" source="ri:notification-3-line.png" />
        				</View>
      			</View>
        				...
        				<View style={styles.frameParent15}>
          					<View style={styles.frameParent16}>
            						<View style={[styles.makifurnitureWrapper, styles.frameChild5Layout]}>
              							<Image style={styles.makifurnitureIcon} resizeMode="cover" source="maki:furniture.png" />
            						</View>
            						<Text style={[styles.furniture, styles.homeTypo]}>Furniture</Text>
          					</View>
          					<View style={styles.frameParent17}>
            						<Image style={[styles.frameChild5, styles.frameChild5Layout]} resizeMode="cover" source="Frame 329.png" />
            						<Text style={[styles.furniture, styles.homeTypo]}>Electronics</Text>
          					</View>
          					<View style={styles.frameParent17}>
            						<Image style={[styles.frameChild5, styles.frameChild5Layout]} resizeMode="cover" source="Frame 329.png" />
            						<Text style={[styles.furniture, styles.homeTypo]}>Packages</Text>
          					</View>
          					<View style={styles.frameParent17}>
            						<Image style={[styles.frameChild5, styles.frameChild5Layout]} resizeMode="cover" source="Frame 329.png" />
  ...
  <View style={{ flex: 1, backgroundColor: '#fff' }} />
      			...
      			<View style={[styles.bottomNavParent, styles.bottomPosition]}>
        				...
        				<Pressable style={styles.materialSymbolsLightcamera} onPress={()=>{}}>
          					<Image style={styles.icon} resizeMode="cover" source="material-symbols-light:camera-outline.png" />
        				</Pressable>
      			</View>
      			<View style={[styles.iphoneStatusBarlower, styles.bottomPosition]}>
